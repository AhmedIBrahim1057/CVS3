						...
						<ul>
							<li class="slide-overlay slide-overlay-primary" data-transition="fade">
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">TOP RESEARCH CENTER, WE ARE</div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-x="center" data-hoffset="['-100','-100','-100','-190']"
									data-y="center"
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-x="center" data-hoffset="['-25','-25','-25','-70']"
									data-y="center"
									data-fontsize="['145','145','145','250']"
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-x="center" data-hoffset="['45','45','45','45']"
									data-y="center"
									data-fontsize="['145','145','145','250']"
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-x="center" data-hoffset="['105','105','105','150']"
									data-y="center"
									data-fontsize="['145','145','145','250']"
									data-lineheight="['150','150','150','260']">3</div>
								...
								<div class="tp-caption font-weight-light text-color-light"
									...
									data-lineheight="['26','26','26','45']">The best choice for Science, Technology & Engineering</div>
								
							</li>
							<li class="slide-overlay" data-transition="fade">
								<img src="img/slides/slide-corporate-1-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
